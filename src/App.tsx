...
export default function App() {
  const { state, initGame, playCard, drawCard, selectSuit, endTurn } = useGameLogic();
  ...
  return (
    <div className="h-screen w-full felt-table relative flex flex-col overflow-hidden">
      {/* Header / Stats */}
      <div className="absolute top-4 left-4 right-4 flex justify-between items-center z-10">
        <div className="bg-black/30 backdrop-blur-md border border-white/10 rounded-full px-4 py-2 flex items-center gap-4">
      ...
      <div className="flex-1 relative flex items-center justify-center p-8">
        ...
        {/* Center Table */}
        <div className="flex items-center gap-12 sm:gap-24 relative z-0">
          {/* Draw Pile */}
        ...
        {state.status === 'game_over' && (
          ...
          >
            <div className="bg-white rounded-3xl p-12 max-w-sm w-full text-center shadow-2xl">
              ...
              <button 
                onClick={initGame}
                className="w-full py-4 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-2xl flex items-center justify-center gap-3 transition-all active:scale-95"
              >
                <RotateCcw size={20} />
                再玩一次
              </button>
